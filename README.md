# Colin Vaufrey, développeur et créateur de jeux vidéo et _serious games_.

**:fr: Français** | [:uk: English](./README_en.md)

## Mes compétences

- 🖥️ **Développement de jeux vidéo**, **_serious games_** et **applications** 🖥️ :
  - **Unity** (C#) ;
  - **Godot Engine** (GDScript) ;
  - **Node.js** (JavaScript, TypeScript) ;
  - **Python** ;
  - **SQL**…
  - … avec de l’expérience dans d’**autres langages** et **technologies** et toujours la possibilité d’en **apprendre** d’**autres** !
- 🎮 **Game design** 🎮 ;
...
<p align="center">
  <a href="https://poulpefaible.itch.io/wawadventure">🎮 Jouer à Wawadventure 🎮</a>
</p>
...
<p align="center">
  <a href="https://icope.rodriguez-vincent.fr/">🎮 Jouer à Alg’audition 🎮</a>
</p>
...
**Buzz Express** est un **projet personnel** qui me tient beaucoup à cœur et que je développe petit à petit depuis plusieurs années. Je développe en parallèle le **client** et le **serveur**. À ce jour, une version basique du jeu est **jouable** et le **multijoueur en ligne** est **fonctionnel**, ainsi que l’ajout de questions et autres fonctionnalités administratives. Le jeu n’est cependant pas encore ouvert au public en attendant qu’il soit prêt. Je m’efforce de rajouter de **nouvelles questions** ainsi que de **nouvelles fonctionnalités** régulièrement.
...
<p align="center">
  <a href="https://the-kiwy.itch.io/contre-nature">🎮 Jouer à Contre-nature 🎮</a>
</p>
...
**The Strafing Game Renewed** est un **projet personnel** basé sur divers prototypes du même nom que j’ai réalisés au fil des ans.
...
#### Jeu VR sur la nutrition

Réalisé sur **2 jours** en équipe avec des étudiants d’[**ISIS**](https://www.univ-jfc.fr/ecole-dingenieurs/informatique-pour-la-sante) : dans cette expérience en **réalité virtuelle**, le joueur peut choisir des aliments et voir en temps réel évoluer ses taux de glycémie, de cholestérol, etc.
**Technologies** : _**Unity** et **C#**._

[![Jeu VR sur la nutrition](https://img.youtube.com/vi/z3opUFHFKTo/maxresdefault.jpg)](https://www.youtube.com/watch?v=z3opUFHFKTo)

<p align="center">Cliquez sur l’image pour voir la vidéo.</p>

#### D’autres projets seront bientôt ajoutés !

<!-- TODO: Ajouter des liens vers les projets 
#### Modélisations 3D

Le bâtiment Élisabeth Lemonnier  
Les modèles du jeu ＶａｐｏｒＤｕｎｇｅｏｎ (sauf les statues lol)

#### Breathless Town

Game Jam DUT Informatique IUT2 Grenoble - 2nde place
Python / Pygame
Jeu de gestion / action
2 phases : gestion de sa ville et de son oxygène, recherche sur le terrain d'argent à dépenser

#### Check’ipes

Logiciel de création d’équipes respectant des règles spécifiques pour les tournois d’échecs en équipe
HTLM5 / PHP / MySQL
...
Unity C#
Gameplay asymétrique : un joueur cherche à empêcher les autres de progresser sur un parcours d'obstacle
...
#### Simulateur de lancer de dés / Chamboule-tout
